...
<script type="text/javascript">
          ...
          $(document).on("click", ".openstudents", function () { //user clicks on button
                          ...
                          $.post( 'prakriti.php', {'studentid': track_page}, function(data){			
	                           ...
	                           {            
                                 $fname=$found['Firstname'];$gender=$found['Gender'];
			                      ...
			                      $standard=$found['Standard'];
			                         if($gender=='Male'){
			                         	echo"<li><a data-id='$ids' href='#' class='openstudentx'><i class='fa fa-child'></i>$fname</a></li>";
			                         }else{
			                         	echo"<li><a data-id='$ids' href='#' class='openstudentx'><i class='fa fa-female'></i>$fname</a></li>";
			                         }
						       }
