...
<!--//Metis Menu -->
 ...
 $(document).on("click", ".open-computers", function () { //user clicks on button
             			...
             			$(".computerstexts").html("<div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Pictures or Videos</span><select style='height:37px;width:100%;border:1px solid;' name='groupopt'  id='studyname' ><option >Select Option</option><option class='open-option1'>Pictures</option><option class='open-option2'>Videos</option></select></div>").prop('disabled', true);
           ...
           $(document).on("click", ".open-computers2", function () { //user clicks on button
             			...
             			$(".videos").html("").prop('disabled', true);
             			$(".pic1").html("").prop('disabled', true);
             			$(".pic2").html("").prop('disabled', true);
             			$(".pic3").html("").prop('disabled', true);
             			$(".video1").html("").prop('disabled', true);
             			$(".video2").html("").prop('disabled', true);
             			$(".video3").html("").prop('disabled', true);
                    
                        
          });
          
          
          $(document).on("click", ".open-option1", function () { //user clicks on button
          ...
          $(document).on("click", ".open-option2", function () { //user clicks on button
             			             			

             			$(".videos").html("<div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>How many videos</span><select style='height:37px;width:100%;border:1px solid;' name='groupopt'  id='studyname' ><option >Select Option</option><option class='open-video1'>1</option><option class='open-video2'>2</option><option class='open-video3'>3</option></select></div>").prop('disabled', true);
          ...
          $(document).on("click", ".open-video1", function () { //user clicks on button
             			             			

             			$(".video1").html("<div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Select video</span><input name='file' type='file' id='file' ></div>").prop('disabled', true);
                        
          });
          $(document).on("click", ".open-video2", function () { //user clicks on button
             			             			

             			$(".video2").html("<div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Select video</span><input name='file' type='file' id='file' ></div><div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Select video</span><input name='file2' type='file' id='file' ></div>").prop('disabled', true);
                        
          });
          
          $(document).on("click", ".open-video3", function () { //user clicks on button
             			             			

             			$(".video3").html("<div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Select video</span><input name='file' type='file' id='file' ></div><div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Select video</span><input name='file2' type='file' id='file' ></div><div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Select video</span><input name='file' type='file' id='file' ></div>").prop('disabled', true);
				...
				<div class="charts">
					<div class="col-md-4 charts-grids widget"  >
                          ...
                          session_destroy(); 	
                           	                ...
                           	                echo"Fill the form below to add multimedia category component";
                                       session_destroy(); }?>
...
<form action="upload.php" method="post"  enctype='multipart/form-data' >
	       ...
	       <div class='input-group' style='margin-bottom:10px'><span class='input-group-addon'>Multimedia Category</span>
	       	<select style='height:37px;width:100%;border:1px solid;' name='groupopt'  id='studyname' >
      ...
      <textarea  name="fulltext" value="" placeholder="Type full discription password" rows="12" cols="45"></textarea>
 
   Add picture<input type="file"  name="file"  >
  

<div class="modal-footer">
      	<input type="submit" class="btn btn-success" value="Submit" id="btns1" name="addmulti"> &nbsp;
      	    </div>
				...
				<div class="clearfix"> </div>
					...
					<div class="col-md-4 charts-grids widget states-mdl">
						...
						<center><h4 class="title">
							...
							<?php if(isset($_SESSION['adduser'])) {echo"Added Multimedia category";
							session_destroy();?>
					    </h4></center>
					    
					   <?php $sqlb ="SELECT * FROM Allworks  ";
                                 $retuser = mysql_query($sqlb);
                                while($found = mysql_fetch_array($retuser))
	                           {
                                 $full = $found['FullDiscription'];
								   $profile = $found['ImageName'];				      
		                        }
	                           if($profile!=''){
	           	                           echo"<center><img class='avatar border-gray' src='multimedia/pictures/$profile' style='margin-bottom:10px;height:200px;width:200px'   alt='...'/></center>";
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="#" target="">Design and Developed by mvumaprakriti@gmail.com</a></p>		
	</div>
    <!--//footer-->
	</div>
