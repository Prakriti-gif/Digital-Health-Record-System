                           ...
                           <?php  }elseif(isset($_SESSION['error'])){
                           	                    	?>
                           	                    	 <div class="alert alert-danger">
                                                          You did not submit subject title or full news content
                                                     </div>
                           	          <?php       
											session_destroy();
                                     }
                           	                ...
                           	                echo"Type the news below & attach media";
                                        }?>
...
<form action="upload.php" method="post"  enctype='multipart/form-data' >
    ...
    <input type="text" name="title" placeholder="Enter news title" style="width: 100%"/>
         </div>
  <div class="input-group" style="margin-bottom:10px">
   
    <textarea rows="8" cols="41" placeholder="Type/paste here full news" name="news"></textarea>  </div>
   ...
   <!-- <input type="button" name="submited" class="action-button" value="Submit" /> -->  
     <button  class="btn btn-success"  value="Enumeration" name="submit">Submit</button> 
				...
				<div class="clearfix"> </div>
					...
					<div class="col-md-4 charts-grids widget states-mdl">
					   ...
					   <?php $sqlnews ="SELECT * FROM LatestNews WHERE Title='$title' ";
                                                ...
                                                if($numn2!=0){
												                   while($found2 = mysql_fetch_array($rgetn2))
																	...
																	echo"<img src='multimedia/pictures/$profile' height='200px' width='200px' alt=''>";	   
						                                                    ...
						                                                    $date=date('d-m-y');
							   echo"<p>$Fullnews</p>";
							   echo"<small style='color: #5261D1;'>Written by <cite title='Source Title'>$firstname</cite> $date</small>";	   
