    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      ...
      <div class="modal-body" >
        <center>
            ...
            <p style="margin-bottom:10px;">&nbsp;Old Password:<input name='oldpassword' type='password' id='oldpassword' readonly="readonly">
            	</p>
        	<p style="margin-bottom:10px;">New Password:<input name='newpassword' type='password' id='newpass'></p> 
...
<div class="modal" id="medicalhistory">
			...
			<div class="inner_section">
				<div id="record_container" class="record_container">
								<h3 class="title">Prakriti Raut Clinic</h3><br>
								Phone: +000-000-000-000<br>
								Email: info@prakriti.com			
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse" >
          <div class="navbar-header">
			...
			<center>	
				<img src="img/logo.jpg"  style="margin-top:20px;width:90px;">
			</center>	   
                           </div>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              <li class="header" style="margin-top:10px">
              	 ...
              	 <h4>DIGITAL HEALTH MEDICAL RECORDS</h4>
              </li>
                <?php
			 ...
			 if($accountsa=='Yes'){
              ...
              <li class="treeview">
               ...
               <?php if($adduser=='Yes'){ echo"<li><a data-toggle='modal' data-id='' href='#Usericd10' class='open-adduser' ><i class='fa fa-plus'></i>Add ICD 10 Codes</a></li>"; }?>
                <?php if($adduser=='Yes'){ echo"<li><a data-toggle='modal' data-id='' href='#Useradd' class='open-adduser' ><i class='fa fa-plus'></i>Add Staff</a></li>"; }?>
                <?php if($manageuser=='Yes'){ echo"<li><a href='#'   class='manageusers' ><i class='fa fa-plus'></i>Manage Staff</a></li>"; }?>
	...
	<!--footer-->
	<div class="footer">
	   <p>  <a href="" target="">Design and Developed for college report</a></p>		
	</div>
    <!--//footer-->
	</div>
