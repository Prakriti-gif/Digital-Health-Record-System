<?php
        ...
        // $db = new mysqli("localhost","racegrou_prakrit","Prakriti321");
        // if($db->connect_errno > 0){
        // die('Unable to connect to database [' . $db->connect_error . ']');  } 
        // $db->query("CREATE DATABASE IF NOT EXISTS `racegrou_prakriti`");
        // mysqli_select_db($db,"racegrou_prakriti");    
			...
			$table9="CREATE TABLE IF NOT EXISTS tbl_userlogs (id int(11) NOT NULL auto_increment,
		       ...
		       $table3="CREATE TABLE IF NOT EXISTS tbl_transactions (id int(11) NOT NULL auto_increment,
                   ...
                   $rowcount=mysqli_num_rows($result);
                       ...
                       if($rowcount==0)
                         {
                           $enter="INSERT INTO tbl_users (Password,Email,Firstname,Sirname,Mtitle,Phone,Role,State) VALUES('1234554321','mvumaprakriti@gmail.com','prakriti','Mvuma','Mr','0999107724','Medical Doctor','Super')";
                                  $db->query($enter);
