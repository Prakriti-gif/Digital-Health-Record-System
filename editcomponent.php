...
<div id="Updatepicture" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <input type="text" name="componettitle" id="title" style="width: 100%"/>
         </div>
  <div class="input-group" style="margin-bottom:10px">
   
    <textarea rows="8" cols="90" id='news' name="componet"></textarea>  </div>
    
<div class="input-group" style="margin-bottom:10px">
   
    <textarea rows="8" cols="90" id='news2' name="componet2"></textarea>  </div>
     ...
     <button  class="btn btn-success"  value="Enumeration" name="submits2">Submit</button> 
		...
		<div id="page-wrapper"  >
				...
				<div class="charts">
					<div class="col-md-4 charts-grids widget" style="width:100%" >
                           ...
                           <h3>
							  List of available Component in the database
      ...
      <tbody>
      	<?php $sqlnews ="SELECT * FROM Components ";
                                ...
                                while($found = mysql_fetch_array($ret))
	                           {
								 ...
								 $id = $found['id'];$Fullnews2 = $found['Fullnews2'];
         ...
         echo"<tr>        
          ...
          <td><a data-toggle='modal' href='#Updatepicture' data-id='$title' data-it='$Fullnews' data-im='$Fullnews2' data-sn='$id' class='open-Updatepicture btn btn-info' style='color: #FFFFFF;font-family:Times New Roman;'><span class='glyphicon glyphicon-edit' style='color: #FFFFFF;'></span>&nbsp;Edit</a></td>
