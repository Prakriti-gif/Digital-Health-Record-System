...
<nav class="navbar navbar-inverse" style="margin-top:5px;background-color:white">
    <div class="container-fluid">
     <div class="banner">
	 <center><div style="color:red;margin-bottom:50px;margin-top:20px;font-size:30px;font-family:Dr Mlombe;">Digital Health Records System</div></center>
                    <center><img src="img/logo.jpg"  style="position:absolute;margin-top:-5%;width:90px"></center>
