    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
        ...
        <h4 class="modal-title" style="font-weight: bold;color: #F0F0F0"><center>
        	Edit &nbsp;<span id='title'></span>&nbsp;Roles
        	</center></h4>
       <p style="color: #F0F0F0">If you check/tick a box it means your giving privilge and vice versa</p>
      </div>
      ...
      <div class="modal-body" >       	
      	<center> 
	       ...
	       <div class='input-group' style='margin-bottom:10px'>
			       Add/Manage Users&nbsp;<input type="checkbox" id="user" name="users">

	       </div>
	       <div class='input-group' style='margin-bottom:10px'>
			       Add/Manage News&nbsp;<input type="checkbox" id="news" name="news">

	       </div>  	
	        
	       <div class='input-group' style='margin-bottom:10px'>
			       Add/Manage Componets&nbsp;<input type="checkbox" id="news" name="componets">

	       </div>  
	       <div class='input-group' style='margin-bottom:10px'>
			       Add/Manage Multimedia&nbsp;<input type="checkbox" id="news" name="multimedia">

	       </div>
	       <div class='input-group' style='margin-bottom:10px'>
			       Add/Manage Privilages&nbsp;<input type="checkbox" id="roles" name="roles">

	       </div>  
	       <div class='input-group' style='margin-bottom:10px'>
			       Add/Manage About us&nbsp;<input type="checkbox" id="abus" name="abus">
      ...
      <div class="modal-footer">
      	<input type="submit" class="btn btn-success" value="Update" id="btns1" name="useroles"> &nbsp;
		...
		<div id="page-wrapper"  >
				...
				<div class="charts">
					<div class="col-md-4 charts-grids widget" style="width:100%" >
                           ...
                           <h3>
							  Table showing user roles and click edit to manage them 					
								</h3>
    ...
    <table class="table table-striped">
      <caption><?php if(isset($_SESSION['editusers'])) {
      	echo"<div class='alert alert-success'>
                You have Successfully Updated user roles
             </div>"; 
			 session_destroy();
      }?> </caption>
      <thead>
      ...
      <tbody>";
      	 $sqlnews ="SELECT * FROM Administrator WHERE id!='$id' ";
                                ...
                                while($found = mysql_fetch_array($ret))
	                           {
		                        ...
		                        $sqlnews ="SELECT * FROM Useroles WHERE Admin='$pass' ";

                                 $rets = mysql_query($sqlnews);
                                if($found = mysql_num_rows($rets)!=0)
	                           {
                                while($found = mysql_fetch_array($rets))
	                           {
                                 $news= $found['News'];$users = $found['Users'];
								 $media = $found['Multimedia'];$compo = $found['Components'];
								 $role = $found['Roles']; $abus = $found['Aboutus'];	
         ...
         echo"<tr>        
          ...
          <td>$role</td>
           <td>$abus</td>
          <td><a data-toggle='modal' href='#Updatepicture' data-if='$name' data-id='$pass' class='open-Updatepicture btn btn-info' style='color: #FFFFFF;font-family:Times New Roman;'><span class='glyphicon glyphicon-edit' style='color: #FFFFFF;'></span>&nbsp;Edit</a></td>
